...
Menu.getSystemAccordion = function(param){
	...
	function systemTreeClick(node){
		...
		if(nodeId=='userList'){
			...
			backup();
			return;
		}else if(nodeId=='loginHistory'){
			tabTitle = "登陆历史";
			tabUrl = param.baseUrl + "/websrc/page/system/loginHistory.jsp";
		}else if(nodeId=='otherSystem'){
			tabTitle = "其他系统";
			tabUrl = param.baseUrl + "/websrc/page/otherSystem/otherSystem.jsp";
		}
		// 	打开Tab页
		Anynote.openTab(tabTitle, tabUrl);
	}
