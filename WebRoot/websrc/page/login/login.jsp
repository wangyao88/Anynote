...
<link href="<%=baseUrl %>/websrc/css/login/main.css" rel="stylesheet" type="text/css" />
<script type="text/javascript">
		$(document).ready(function(){
            ...
            function initNewNoteData(){
				Ext.Ajax.request({
					url: '<%=baseUrl %>/noteAction.do?method=queryNewNote&count=10',
					success: function(response, options){
					   initReportData();
					}
			    });
            ...
            function initReportData(){
				Ext.Ajax.request({
					url: '<%=baseUrl %>/accountAction.do?method=selectReportData&count=10&isLogin=yes',
					success: function(response, options){
					   initYearGaugeData();
					}
			    });
            ...
            function initYearGaugeData(){
				Ext.Ajax.request({
					url: '<%=baseUrl %>/accountAction.do?method=getYearRate',
					success: function(response, options){
					   trunToHomePage();
					}
			    });
...
<script type="text/javascript" src="<%=baseUrl %>/websrc/js/login/jQuery.js"></script>
<script type="text/javascript" src="<%=baseUrl %>/websrc/js/login/fun.base.js"></script>
<script type="text/javascript" src="<%=baseUrl %>/websrc/js/login/script.js"></script>


<!--[if IE 6]>
<script src="<%=baseUrl %>/websrc/js/login/DD_belatedPNG.js" type="text/javascript"></script>
