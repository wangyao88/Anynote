		...
		$(document).ready(function(){
		    ...
		    var todoListToolbar = new Ext.Toolbar({
		    	...
		    	items: [
				    ...
				    new Ext.Button({
					    id: 'todoList-add-batch-button',
						text: '批量添加明天待办',
						iconCls: 'icon-active'
					}),
				    new Ext.Button({
					    id: 'todoList-add-date-batch-button',
						text: '指定日期添加',
						iconCls: 'icon-active'
					}),
					new Ext.Button({
			...
			// 批量添加按钮
			$("#todoList-add-batch-button").click(function(){
				Anynote.ajaxRequest({
					baseUrl: '<%=baseUrl %>',
					action: '/todoAction.do?method=iniTtomorrowTodo',
			...
			// 指定日期添加按钮
			$("#todoList-add-date-batch-button").click(function(){
			    var dateTodoFormPanel = new Ext.FormPanel({
			          id: 'dateTodoFormPanel',
			          labelWidth: 40,
			          border: false,
			          buttonAlign: 'center',
	                    ...
	                    handler: function(){
							...
							if(date==""){
								...
								Anynote.ajaxRequest({
									...
									action: '/todoAction.do?method=initDateTodo',
									callback: function(jsonResult){
										Ext.getCmp("todoListGrid").getStore().reload();
										dateTodoWin.close();
									},
			    ...
			    var dateTodoWin = new Ext.Window({
			        title: '指定日期待办添加',
					width: 200,
					height: 100,
					modal: true,
