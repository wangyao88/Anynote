...
public class ImageUtils
{
  ...
  public static void saveImageAsJpg(String fromFileStr, String saveToFileStr, int formatWideth, int formatHeight)
    throws Exception
  {
  ...
  public static void saveImageAsJpg(String fromFileStr, String saveToFileStr, double scale)
    throws Exception
  {
    ImageUtils iu = new ImageUtils();
