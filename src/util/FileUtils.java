...
public class FileUtils extends org.apache.commons.io.FileUtils
{
  ...
  public static void createFileWithEncoder(String filePath, String content, String encoder)
    throws Exception
  {
  ...
  public static String save(File f, String path)
    throws Exception
  {
  ...
  public static String saveHtmlImgToLocal(String domain, String html, String savePath)
  {
    ...
    for (int i = 0; i < imgs.size(); i++)
    {
      ...
      if ((Pattern.matches(regex, imgOldUrl)) && (!imgOldUrl.startsWith(domain)))
      {
        ...
        try
        {
          ...
          imgNewUrl = domain + MessageUtils.setParamMessage("/websrc/file/{0}/picture", new String[] { SessionUtils.getCurrentUserId() }) + "/" + ymd + "/" + imgName;
